<template >
  <div class="container-contact101">
    <div class="wrap-contact100">
      <form class="contact100-form validate-form"  @submit.prevent="sendOfferInquiry">
                <span class="contact100-form-title">
                 Get An Offer In As Little As 24 Hrs!
                </span>
        ...
        <label class="label-input100" for="price">Asking Price</label>
        <div class="wrap-input100">
  ...
  export default {
    ...
    methods: {
      sendOfferInquiry: function () {
        ...
        this.$store.dispatch('offerInquiry', { firstName,lastName,
