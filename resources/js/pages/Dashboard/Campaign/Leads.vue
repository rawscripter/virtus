            ...
            <md-card>
                ...
                <md-card-content>
                    <div class="text-right">
                        <md-button class="md-primary md-dense" @click="addLead">
                            Add Lead
                        </md-button>
                    </div>
                    <div class="md-layout">
                        <div class="md-layout-item md-size-20">
                            <md-table
                                ...
                                <md-table-row slot="md-table-row" slot-scope="{ item}" @click="getCampaignList(item)" >
                                    <md-table-cell md-label="Status" md-sort-by="name">{{item.name}} ({{item.size}})</md-table-cell>
                                    <md-table-cell md-label="">
                                        <md-button class="md-icon-button md-raised md-round md-info" style="margin: .2rem;">
