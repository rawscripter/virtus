<template>
    <div class="full-page" :class="{ 'nav-open': $sidebar.showSidebar }">
        <div class="md-toolbar md-absolute md-theme-default md-elevation-0" id="toolbar" color-on-scroll="400">
            <md-toolbar md-elevation="0" class="md-transparent md-toolbar-absolute">
                <div class="md-toolbar-row md-offset">
                    ...
                    <div class="md-toolbar-section-end">
                        ...
                        >
                            <md-list>
                                <md-list-item href="/home" @click="linkClick">
                                    <md-icon>home</md-icon>
                                    Home
                                </md-list-item>
                                <md-list-item href="/register"  @click="linkClick" v-if="!$store.getters['isAuthenticated']">
